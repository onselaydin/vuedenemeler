...
<script>
    ...
    export default {
        ...
        methods: {
            onSubmit() {
                //actipmlar dispatch ile çağrılır.login metodunu çağırıyoruz.
                //...this.user sayesinde data return userdaki email ve password vs yazmak zorunda kalmıyorum o kesip alıyor.
                //storeda action daki login'e authData ya aşağıdaki parametreleri gönderdik.
